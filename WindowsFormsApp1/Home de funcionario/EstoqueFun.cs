...
namespace WindowsFormsApp1
{
    public partial class EstoqueFun : Form
    {
        ...
        private void btnEFunA1_Click(object sender, EventArgs e)
        {
            ...
            string updateProdutoQuery = "UPDATE Produto SET quantidadeProduto = @quantidade, valorKg = @valorKg WHERE nomeProduto = @nomeProduto";


            string insertEstoqueQuery = "INSERT INTO Estoque (IDProduto) VALUES ((SELECT IDProduto FROM Produto WHERE nomeProduto = @nomeProduto))";
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                updateCommand.Parameters.AddWithValue("@valorKg", valorKg);
                updateCommand.Parameters.AddWithValue("@nomeProduto", nomeProduto);

                SqlCommand insertCommand = new SqlCommand(insertEstoqueQuery, connection);
                insertCommand.Parameters.AddWithValue("@nomeProduto", nomeProduto);
        ...
        private void mskEFunADP_Click(object sender, EventArgs e)
        {
            mskEFunADP.Select(0, 0);
        }

        private void mskEFunADP_Enter(object sender, EventArgs e)
        {
            mskEFunADP.Select(0, 0);
        }

        private void mskEFunADV_Click(object sender, EventArgs e)
        {
            mskEFunADV.Select(0, 0);
        }

        private void mskEFunADV_Enter(object sender, EventArgs e)
        {
            mskEFunADV.Select(0, 0);
        }
    }
